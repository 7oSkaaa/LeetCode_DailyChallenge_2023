...
function isSymmetric(root: TreeNode | null): boolean {
    let rightBranch: number[] = [], leftBranch: number[] = [];

    // Function to traverse the right branch and store its values
    function storeRightValues(node: TreeNode | null | undefined): void {
        if (!node) {
    ...
    function storeLeftValues(node: TreeNode | null | undefined): void {
        if (!node) {
