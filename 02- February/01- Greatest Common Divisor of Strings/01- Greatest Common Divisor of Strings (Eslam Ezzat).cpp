...
public:
    string gcdOfStrings(string str1, string str2) {
        ...
        if (str1 + str2 != str2 + str1) {
            ...
            // recursive the substr of str1 of the size of str2 and str2
            return gcdOfStrings(str1.substr(str2.length()), str2);
        } else {
            // If the size of str2 is less than the size of str1
            // Recursive the substr of str2 of the size of str1 and str1
